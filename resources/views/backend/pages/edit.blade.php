            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <!--Horizontal Form-->
                        <!--===================================================-->
                        {!! Form::model($page, ['route' => ['backend.pages.update',$page->id], 'class'=>'form-horizontal', 'method'=>'PUT', 'files'=>'true']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group {{ $errors->has('title_sw') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            {{Form::text('slug', $page->slug,['class'=>'form-control','placeholder'=>'Enter Slug'])}}
                                            @if ($errors->has('slug'))
                                    ...
                                    <div class="form-group{{ $errors->has('title_sw') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            {{ Form::text('title_sw', $page->title_sw,['class'=>'form-control','placeholder'=>'Enter Name'])}}
                                    ...
                                    <div class="form-group{{ $errors->has('title_en') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            {{Form::text('title_en', $page->title_en,['class'=>'form-control','placeholder'=>'Enter Name'])}}
                                    ...
                                    <div class="form-group {{ $errors->has('details_sw') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            {{Form::textarea('description_sw', $page->details_sw,['class'=>'form-control tinymce','placeholder'=>'Enter Description'])}}
                                    ...
                                    <div class="form-group {{ $errors->has('description_en') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            {{Form::textarea('description_en', $page->details_sw,['class'=>'form-control tinymce','placeholder'=>'Enter Description'])}}
                                    ...
                                    @if($page->file_sw)
                                        <div class="form-group">
                                            <div class="col-sm-9 col-sm-offset-3">
                                                <img src="{{url('uploads/pages/'.$page->file_sw)}}" class="img-fluid img-thumbnail" alt="Responsive image">
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if($page->file_en)
                                        <div class="form-group">
                                            <div class="col-sm-9 col-sm-offset-3">
                                                <img src="{{url('uploads/pages/'.$page->file_en)}}" class="img-fluid img-thumbnail" alt="Responsive image">
                                            </div>
                                        </div>
                                    @endif
                        ...
                        <div class="panel-footer text-right">
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <button class="btn btn-primary btn-block" type="submit"><strong>Update Page</strong></button>
                                </div>
                            </div>
                        </div>
                    {!! Form::close() !!}
