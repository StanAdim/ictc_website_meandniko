            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <!--Horizontal Form-->
                        <!--===================================================-->
                        {!! Form::open(['route' => 'backend.investments.store', 'class'=>'form-horizontal','autocomplete'=>'off', 'files' => true]) !!}
                        ...
                        <div class="panel-footer text-right">
                            <div class="row">
                                <div class="col-md-6 col-md-offset-2">
                                    <button class="btn btn-primary btn-block" type="submit">Add New Investment</button>
                                </div>
                            </div>
                        </div>
                    {!! Form::close() !!}
