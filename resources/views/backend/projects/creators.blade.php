...
@section('title', 'Project OWners List')
            ...
            <div class="panel">
                <div class="panel-heading">
                    <div class="panel-control">
                        ...
                        <a href="{{ route('backend.projects.supervisors') }}" class="btn btn-primary btn-lg m-1">Referees | Supervisers</a>
                    </div>
                ...
                {{-- {{-- <div class="panel-body"> --}}
                    <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        @foreach($creators as $key => $creator)
                            ...
                            <tr class="text-dark">
                                <td>{{$key}}</td>
                                <td>{{$creator->firstName}} {{$creator->secondName}}</td>
                                <td>{{date('d-m-Y',strtotime($creator->dob))}}</td>

                                <td>{{$creator->gender}}</td>
                                <td>
                                    <span class="text-primary">{{$creator->phoneNumber}}</span>  
                                    | <span class="text-primary">{{$creator->email}}</span> 
