            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <!--Horizontal Form-->
                        <!--===================================================-->
                        {!! Form::open(['route' => 'backend.socials.store', 'class'=>'form-horizontal','autocomplete'=>'off', 'files' => true]) !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group{{ $errors->has('link') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            {{Form::text('link', null,['class'=>'form-control','placeholder'=>'Enter Social link'])}}
                                            @if ($errors->has('link'))
                                                <span class="help-block">
                        ...
                        <div class="panel-footer text-right">
                            <div class="row">
                                <div class="col-md-6 col-md-offset-2">
                                    <button class="btn btn-primary btn-block" type="submit">Save Social</button>
                                </div>
                            </div>
                        </div>
                    {!! Form::close() !!}
