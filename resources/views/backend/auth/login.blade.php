    ...
    <div class="cls-content">
        <div class="cls-content-lg panel">
            <div class="panel-body" style="background-color: #fff;">
                <div class="mar-ver">
                    {{-- <img src="{{asset('assets/img/jsp.png')}}" class="img img-rounded img-responsive" width="150px;" style="margin: 0 auto"/> --}}
                    <h3 class="h3 mar-no">Dry Bulk Handling Equipment Management System</h3>
                    <br/>
