                ...
                <div class="panel-body">
                    <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        @foreach($awards as $key => $award)
                            ...
                            <tr>
                                <td>{{$index}}</td>
                                <td>{{$award->$title_var ?? $title_var2}}</td>
                                <td>
                                    {{ substr(strip_tags($award->$description_var ?? $description_var2),0,200) }} ...
                                </td>
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal{{$award->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form method="POST" action="{{route('backend.awards.destroy', $award->id)}}">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel{{$award->id}}">Delete</h5>
