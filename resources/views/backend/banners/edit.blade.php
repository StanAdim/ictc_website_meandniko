            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <!--Horizontal Form-->
                        <!--===================================================-->
                        {!! Form::model($banner, ['route' => ['backend.banners.update',$banner->id], 'class'=>'form-horizontal', 'method'=>'PUT', 'files'=>'true']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group{{ $errors->has('title_sw') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            {{ Form::text('title_sw', $banner->title_sw,['class'=>'form-control','placeholder'=>'Enter Name'])}}
                                    ...
                                    <div class="form-group{{ $errors->has('title_en') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            {{Form::text('title_en', $banner->title_sw,['class'=>'form-control','placeholder'=>'Enter Name'])}}
                                    ...
                                    <div class="form-group {{ $errors->has('details_sw') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            {{Form::textarea('details_sw', $banner->details_sw,['class'=>'form-control','placeholder'=>'Enter Description'])}}
                                    ...
                                    <div class="form-group {{ $errors->has('details_en') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            {{Form::textarea('details_en', $banner->details_sw,['class'=>'form-control','placeholder'=>'Enter Description'])}}
                                    ...
                                    <div class="form-group{{ $errors->has('link_url') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            {{Form::text('link_url', $banner->link_url,['class'=>'form-control','placeholder'=>'Enter Name'])}}
                                    ...
                                    @if($banner->file_sw)
                                        <div class="form-group">
                                            <div class="col-sm-9 col-sm-offset-3">
                                                <img src="{{url('uploads/banners/'.$banner->file_sw)}}" class="img-fluid img-thumbnail" alt="Responsive image">
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if($banner->file_en)
                                        <div class="form-group">
                                            <div class="col-sm-9 col-sm-offset-3">
                                                <img src="{{url('uploads/banners/'.$banner->file_en)}}" class="img-fluid img-thumbnail" alt="Responsive image">
                                            </div>
                                        </div>
                                    @endif
                        ...
                        <div class="panel-footer text-right">
                            <div class="row">
                                <div class="col-md-7 col-md-offset-2">
                                    <button class="btn btn-primary btn-block"  id="registerStudent" type="submit">Update Banner</button>
                                </div>
                            </div>
                        </div>
                    {!! Form::close() !!}
