...
@section('content')
    @include('frontend.includes._camera_slider')
    @php
    ...
    @if($home_section)
        ...
        @endphp
        <section class="section content-row-no-bg home-welcome">
            <div class="container">
                            ...
                            <div class="row m-1">
                                <a href="">
                                    ...
                                    <div class="col-md-12 text-center my-2">
                                        ...
                                        <a class="button button-primary-outline button-winona wow slideInUp" href="{{route('frontend.leaders.single', $leader->id)}}" style="visibility: visible; animation-name: slideInUp;">
...
{{--    <script src="{{ URL::asset(url('js/flexslider/jquery.flexslider.js'))}}"></script>--}}
    <script src="{{ URL::asset(url('assets/js/camera.min.js'))}}"></script>
...
@push('after-styles')
    ...
    <link rel="stylesheet" href="{{ URL::asset(url('assets/css/camera.css'))}}" id="main-styles-link">
@endpush